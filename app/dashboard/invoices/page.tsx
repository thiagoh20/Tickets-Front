...
const Page = () => {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center bg-gray-100">
      <h1 className="text-2xl font-bold my-[2.5%] text-center">Facturas del {park == 'PN' ? 'Parque Norte' : 'Aeroparque'}</h1>
      ...
      <div className="flex-grow w-full max-w-6xl mx-auto mt-8">
        {park === 'PN' && <Invoices park="Parque Norte" />}
        {park === 'AP' && <Invoices park="Aeroparque" />}
      </div>
    </div>
  );
};
