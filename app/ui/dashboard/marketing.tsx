import { ChartBarIcon, ChartPieIcon, ClipboardDocumentIcon, Cog8ToothIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="grid w-[95%] grid-cols-2 gap-2">
      ...
      <Link href="/dashboard/graphs-interactions">
        <div className="flex h-full items-center bg-gray-200 p-4">
          <ChartPieIcon width={300} className="mr-2 text-blue-500" />
          <p className="text-lg font-semibold">Interacciones</p>
        </div>
      </Link>
      <Link href="/dashboard/parks">
        <div className="flex h-full items-center bg-gray-200 p-4">
          <Cog8ToothIcon width={300} className="mr-2 text-teal-500" />
